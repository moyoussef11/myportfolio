...
export const projects = [
  {
    ...
    image: ChatApp,
    desc: 'A full MERN stack real-time chat platform featuring private and group conversations with live updates via Socket.io, user authentication, online users tracking, and 32 customizable themes using DaisyUI and Tailwind CSS.',
    demo: '',
    repo: 'https://github.com/moyoussef11/chat-app-real-time-',
    skills: [
      'React.js',
      'Node.js',
      'Express.js',
